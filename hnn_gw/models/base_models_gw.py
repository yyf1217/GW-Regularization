...
class NCModel(BaseModel):
    ...
    def compute_metrics(self, embeddings, data, xy, split):
        ...
        loss = F.nll_loss(output, data['labels'][idx], self.weights) + self.beta * GW_distance
...
class LPModel(BaseModel):
    ...
    def compute_metrics(self, embeddings, data, xy, split):
        ...
        loss = loss + self.beta * GW_distance
